...
class OrderBook {
 ...
 public:
   ...
   *   bool - Choice to print price or quantity, true for price, false for
   * quantity unsigned int - The index of the entry to print (1 - 5
   * corresponding to lowest/highest bid/ask)
   */
