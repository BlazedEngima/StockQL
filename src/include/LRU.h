...
class LRUCache {
    private:
        ...
        */
        ...
        /*
        *   A map of key to the corresponding node in the cache_list serves as a lookup table
        */
        std::unordered_map<uint64_t, std::list<std::pair<uint64_t, RecordData>>::iterator> cache_map;
